 <?php
    ...
    $ha_backgroung = get_the_post_thumbnail_url( $aboutus_pageID ); 
    if(!empty($aboutus_page)):
        ?>
        <section class='container-fluid aboutus' id='about-us' style ='background-image:url("<?php echo $ha_backgroung; ?>");' >
